...
def get_cities_weather(twday_key: str, locations_name: list):
  header = {'Accept':'application/json'}
  parameters = {
        'Authorization' : twday_key , 
...
if __name__ == '__main__':
  twday_key = os.getenv("TWDAY_KEY" , None)
  locations =  ['桃園市', '臺中市', '彰化縣']

  if twday_key :
    pprint(get_cities_weather(twday_key, locations))
  else:
    print("miss api_key")   